...
export default function ActiveLeftRail({ onReturnToDraft, sessions }: ActiveLeftRailProps) {
  return (
      ...
      <div className="flex-1 overflow-y-auto space-y-1">
        ...
        {sessions.slice(0, 6).map((session, index) => (
          <div
            ...
            className={`rounded-md px-3 py-3 transition-all duration-300 ${
              index === 0
          ...
          >
            <div className="mb-1.5 flex items-center gap-3">
              <span className={`material-symbols-outlined ${index === 0 ? 'text-primary' : ''}`} data-icon="chat_bubble">
                chat_bubble
              </span>
